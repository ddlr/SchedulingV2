...
const initialTherapists = [
    { id: 't1', name: 'Breanne Hawkins', team_id: 'team-2', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't2', name: 'Ramsey Mahaffey', team_id: 'team-3', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't3', name: 'Britney Little', team_id: 'team-2', qualifications: ['BCBA','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't4', name: 'Amanda Lewis', team_id: 'team-1', qualifications: ['BCBA','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't5', name: 'Katie Marsico', team_id: 'team-2', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't6', name: 'Skyelar Mcleod', team_id: 'team-2', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't7', name: 'Renee Gilbert', team_id: 'team-2', qualifications:['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't8', name: 'Samantha Wheatley', team_id: 'team-3', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't9', name: 'Skylar Morley', team_id: 'team-2', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't10', name: 'Alexis Price', team_id: 'team-3', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't11', name: 'Courtney Edge', team_id: 'team-2', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't12', name: 'Adriana Lutzio', team_id: 'team-3', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't13', name: 'Sierra Hughes', team_id: 'team-3', qualifications: ['RBT','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't14', name: 'Hannah Holloway', team_id: 'team-3', qualifications: ['BLS','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't15', name: 'Alyssa Lidard', team_id: 'team-3', qualifications: ['BCBA','BLS','TRICARE','TRICARE','MD MEDICAID'], can_provide_allied_health: []},
 { id: 't16', name: 'Brittany Pender', team_id: 'team-3', qualifications: ['BLS','MD MEDICAID'], can_provide_allied_health: [] },
 { id: 't17', name: 'Izaiah Plaza', team_id: 'team-3', qualifications: ['MD MEDICAID'],can_provide_allied_health: [] }


];

const initialClients = [
  { id: 'c1', name: 'JaxBri', team_id: 'team-2', insurance_requirements: [' MD Medicaid' ], allied_health_needs: [] },
  ...
  then(resolve: (value: { data: any, error: any }) => void, reject: (reason?: any) => void) {
    ...
    try {
      if (typeof localStorage !== 'undefined') {
          ...
          // Fallback for worker context where localStorage is missing
          if (this.table === 'teams') allRows = initialTeams;
          else if (this.table === 'therapists') allRows = initialTherapists;
          else if (this.table === 'clients') allRows = initialClients;
          else if (this.table === 'settings') allRows = initialSettings;
          else allRows = [];
      }
    } catch (e) {
      allRows = [];
